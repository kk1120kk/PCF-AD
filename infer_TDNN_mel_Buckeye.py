...
# -*- coding: utf-8 -*-
"""
TDNN (mel 特征) 推理 Buckeye 测试集 → PPG
输出目录: /root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/TDNN_mel_Buckeye/
"""
import os
import torch
...
def main():
    MODEL_CKPT = "/root/autodl-tmp/phn_ASR_2/hk_compare/mel_tdnn_Buckeye_20260806_104343/best_epoch38_valacc68.22_20260806_104343.pth"

    INPUT_DIR  = "/root/autodl-tmp/phn_ASR_2/Buckeye3_hk_clean_train_val_test_70_15_15/feat_80fbank_20ms/test"
    OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/TDNN_mel_Buckeye/test"
