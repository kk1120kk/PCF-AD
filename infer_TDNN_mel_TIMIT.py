...
# -*- coding: utf-8 -*-
"""
TDNN (mel 特征) 推理 TIMIT 测试集 → PPG
输出目录: /root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/TDNN_mel_TIMIT/
"""
import os
import torch
...
def main():
    MODEL_CKPT = "/root/autodl-tmp/phn_ASR_2/hk_compare/mel_tdnn_TIMIT_20260806_104615/best_epoch38_valacc78.03_20260806_104615.pth"

    INPUT_DIR  = "/root/autodl-tmp/phn_ASR_2/TIMIT_data/TIMIT_80fbank_feat_and_label_20ms/TEST/feat"
    OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/TDNN_mel_TIMIT/test"
    ...
    with torch.no_grad():
        for idx, fname in enumerate(feat_files):
            ...
            feat_240 = torch.cat([feat_tensor, d1, d2], dim=-1)
            input_tensor = feat_240.unsqueeze(0).transpose(1, 2)
