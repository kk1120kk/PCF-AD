...
# MODEL_CKPT = "/root/autodl-tmp/phn_ASR_2/hk_train_ckpt/hubert_HIDDEN=12_dfsmn_win=10_LR=1e-4_dropout=05_layer=4_20260722_155417/best_epoch21_valacc86.23_20260722_155417.pth"

# # 2. 数据集特征目录（输入）与后验输出目录（独立配置）
# #    提示：若某个数据集不需要推理，可将对应目录设为 None 或跳过

# # ----- 训练集 -----
# TRAIN_FEAT_DIR   = "/root/autodl-tmp/phn_ASR_2/data/hubert_hidden_states/layer_12/TRAIN/feat"
# TRAIN_OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/data/hubert_PPG/train"

# # ----- 验证集 -----
# VAL_FEAT_DIR     = "/root/autodl-tmp/phn_ASR_2/data/hubert_hidden_states/layer_12/VAL/feat"
# VAL_OUTPUT_DIR   = "/root/autodl-tmp/phn_ASR_2/data/hubert_PPG/val"

# # ----- 测试集 -----
# TEST_FEAT_DIR    = "/root/autodl-tmp/phn_ASR_2/data/hubert_hidden_states/layer_12/TEST/feat" 
# TEST_OUTPUT_DIR  = "/root/autodl-tmp/phn_ASR_2/data/hubert_PPG/test"

# ======================== 配置区（Buckeye） ========================

# 1. 模型检查点路径（训练得到的最佳 .pth）
MODEL_CKPT = "/root/autodl-tmp/phn_ASR_2/hk_train_ckpt_Buckeye_new_split3/hubert_HIDDEN=12_dfsmn_win=10_LR=1e-4_dropout=05_layer=4_20260730_165835/best_epoch34_valacc79.22_20260730_165835.pth"
...
TRAIN_OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/Buckeye3_hk_clean_train_val_test_70_15_15/hubert_PPG/train"

# ----- 验证集 -----
VAL_FEAT_DIR     = "/root/autodl-tmp/phn_ASR_2/Buckeye3_hk_clean_train_val_test_70_15_15/hubert_hidden_states/layer_12/val/feat"
VAL_OUTPUT_DIR   = "/root/autodl-tmp/phn_ASR_2/Buckeye3_hk_clean_train_val_test_70_15_15/hubert_PPG/val"
...
TEST_OUTPUT_DIR  = "/root/autodl-tmp/phn_ASR_2/Buckeye3_hk_clean_train_val_test_70_15_15/hubert_PPG/test"
