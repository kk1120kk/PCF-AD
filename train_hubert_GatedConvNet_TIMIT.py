...
prename = "gatedconvnet_hubert_TIMIT"
...
def create_log_file(log_path, config_dict):
    with open(log_path, 'w', encoding='utf-8') as f:
        f.write("HuBERT + GatedConvNet - Training Log\n")
...
def main():
    config = {
        'train_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/hubert_hidden_states/layer_12/TRAIN/feat",
        'train_label_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/timit_label_20ms/hk_train/label",
        'val_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/hubert_hidden_states/layer_12/VAL/feat",
        'val_label_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/timit_label_20ms/hk_val/label",
        'test_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/hubert_hidden_states/layer_12/TEST/feat",
