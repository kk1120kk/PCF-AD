...
# # ======================== 配置区 (TIMIT)========================
# # 1. 模型权重文件路径
# CHECKPOINT = "/root/autodl-tmp/phn_ASR_2/hk_compare_3SSL_Expert/GateConv_TIMIT_CatPrior_20260801_105410/best_val86.55_test86.56_20260801_105410.pth"
...
# OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/GateConv_Expert_TIMIT/test"
...
# ======================== 配置区 (Buckeye)========================
# 1. 模型权重文件路径
CHECKPOINT = "/root/autodl-tmp/phn_ASR_2/hk_compare_3SSL_Expert/GateConv_Buckeye_CatPrior_20260801_110923/best_val80.29_test80.36_20260801_110923.pth"
...
# 3. 输出目录（融合后的 PPG 保存位置）
OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/GateConv_Expert_Buckeye/test"
