...
def main():
    config = {
        'train_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/w2v2_hidden_states/layer_10/TRAIN/feat",
        'train_label_dir': '/root/autodl-tmp/phn_ASR_2/TIMIT_data/timit_label_20ms/hk_train/label',
        'val_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/w2v2_hidden_states/layer_10/VAL/feat",
        'val_label_dir': '/root/autodl-tmp/phn_ASR_2/TIMIT_data/timit_label_20ms/hk_val/label',
        'test_feat_dir': "/root/autodl-tmp/phn_ASR_2/TIMIT_data/w2v2_hidden_states/layer_10/TEST/feat",
