...
# -*- coding: utf-8 -*-
"""
GatedConvNet (mel 特征) 推理 TIMIT 测试集 → PPG
输出目录: /root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/GatedConv_mel_TIMIT/
"""
import os
import torch
...
def main():
    MODEL_CKPT = "/root/autodl-tmp/phn_ASR_2/hk_compare/mel_gatedconv_TIMIT_20260806_105158/best_epoch35_valacc71.27_20260806_105158.pth"

    INPUT_DIR  = "/root/autodl-tmp/phn_ASR_2/TIMIT_data/TIMIT_80fbank_feat_and_label_20ms/TEST/feat"
    OUTPUT_DIR = "/root/autodl-tmp/phn_ASR_2/hk_compare_get_PPG/GatedConv_mel_TIMIT/test"
