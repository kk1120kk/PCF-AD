...
# -*- coding: utf-8 -*-
"""
80 维 FBank (+Δ+Δ²) + BLSTM 训练脚本 —— Buckeye 数据集
"""
import os
import datetime
import time
...
def create_log_file(log_path, config_dict):
    with open(log_path, 'w', encoding='utf-8') as f:
        f.write("80FBank + BLSTM (Buckeye) - Training Log\n")
...
def train_one_epoch(epoch, model, train_loader, val_loader, test_loader, optimizer, criterion,
    ...
    for padded_feat, padded_label, lengths in pbar:
        ...
        feats = padded_feat          # (B, T, 240)
        logits = model(feats)         # (B, T, 40)
